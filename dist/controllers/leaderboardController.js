...
exports.getMostImprovedAgent = exports.getMonthlyLeaderboard = exports.getWeeklyLeaderboard = exports.getDailyLeaderboard = exports.getLeaderboardOverview = void 0;
...
const buildRankingForRange = async (start, end) => {
    const members = await prisma_1.default.teamMember.findMany({
        orderBy: {
            fullName: "asc",
        },
    });
    const ranking = await Promise.all(members.map(async (member) => {
...
exports.getLeaderboardOverview = getLeaderboardOverview;
...
const getMostImprovedAgent = async (req, res) => {
    try {
        const month = typeof req.query.month === "string" ? Number(req.query.month) : undefined;
        const year = typeof req.query.year === "string" ? Number(req.query.year) : undefined;
        const now = new Date();
        ...
        const comparison = await Promise.all(members.map(async (member) => {
...
exports.getMostImprovedAgent = getMostImprovedAgent;
